...
function refuseUnknownReads(fields, prefix) {
	return new Proxy(fields, { get(target, key) {
		...
		throw new Error(`the legacy-context adapter provides only runtime.cwd, runtime.env and runtime.signal; ${prefix}${key} was read`);
	} });
}
function legacyOperationContext(ctx) {
...
function projectNotFoundError(projectId) {
	return new CliStructuredError("SERVICE.PROJECT_NOT_FOUND", "Project not found", {
...
//#endregion
//#region ../cli/src/auth/refresh.ts
...
//#endregion
//#region ../cli/src/auth/workspace-name.ts
...
//#endregion
//#region ../cli/src/package-manager-runner.ts
...
//#endregion
//#region ../cli/src/update-check.ts
