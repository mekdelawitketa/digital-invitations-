...
import { t as alchemyCommandLine } from "./run-alchemy--ZIvgqyU-DWvpeRrI.mjs";
...
async function devWithDeps(input, deps) {
	...
	let executor;
	try {
		executor = await import("./execute-dev-CQ0Lo2eN-WebHkuDn.mjs");
	} catch (error) {
...
async function logWithDeps(input, deps) {
	...
	let executor;
	try {
		executor = await import("./execute-log-CUzTOzSj-DPxnEKA2.mjs");
	} catch (error) {
