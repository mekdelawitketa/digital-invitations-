...
async function deployWithDeps(input, deps) {
	...
	let executor;
	try {
		executor = await import("./execute-deploy-destroy-Bsdh8hf4-ConszqTa.mjs");
	} catch (error) {
...
async function devWithDeps(input, deps) {
	...
	let executor;
	try {
		executor = await import("./execute-dev-CQ0Lo2eN-BL3PmI0m.mjs");
	} catch (error) {
...
async function logWithDeps(input, deps) {
	...
	let executor;
	try {
		executor = await import("./execute-log-CUzTOzSj-v-J7hbAb.mjs");
	} catch (error) {
